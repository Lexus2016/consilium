...
SYNTH_INSTRUCTIONS = (
    ...
    "NONE of the members reported any finding (no SOURCE citations survive), "
    "output exactly one line: NO_FINDINGS (and nothing else) — never output "
    "NO_FINDINGS together with any finding. If "
