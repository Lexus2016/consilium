...
assistant in plain words (shown in quotes); it works out the rest.
...
The other AI answers, your assistant shows you the reply and says what it makes of
it, and you decide. Nothing in your files changes unless you say so.
